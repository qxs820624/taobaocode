...
def difftime(t):
    interval = datetime.datetime.now() - t
    diff = interval.days * 24 * 3600 + interval.seconds
    if diff < 60:
        result = _("just")
    elif diff / 60 < 60:
        result = str(diff / 60) +  _("minuts_ago")
    elif diff / 60 / 60 < 24:
        result = str(diff / 60 / 60) +  _("hours_ago")
    elif diff / 60 / 60 / 24 < 30:
        result = str(diff / 60 / 60 / 24) + _("days_ago")
    elif  diff / 60 / 60 / 24 / 30 < 12:
        result = str(diff / 60 / 60 / 24 / 30) + _("month_ago")
    else:
        result = str(diff / 60 / 60 / 24 / 30 / 12) + _("years_ago")
    return  result
